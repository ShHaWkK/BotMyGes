...
exports.getCampusLocation = void 0;
...
function getCampusLocation(key) {
    var _a;
    return (_a = CAMPUS_LOCATIONS[key]) !== null && _a !== void 0 ? _a : [undefined, '11'];
}
exports.getCampusLocation = getCampusLocation;
